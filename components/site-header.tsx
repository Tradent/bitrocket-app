...
export function SiteHeader() {
  ...
  return (
    <header
      className="px-6 lg:px-10 py-6 flex items-center justify-between backdrop-blur-xl bg-black/30 fixed w-full z-50 transition-all duration-300 border-b border-purple-500/10"
      style={{
    ...
    >
      <div className="flex items-center gap-3">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="font-bold text-xl bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent">
            BitRocket
          </span>
        </Link>
      </div>
